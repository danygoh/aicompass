            ...
            {showAddUser && (
              <div style={{background:'#fff',border:'1px solid #e5e7eb',borderRadius:12,padding:20,marginBottom:16}}>
                ...
                <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:16}}>
                  ...
                  <div><label style={{fontSize:12,color:'#6b7280',display:'block',marginBottom:4}}>Tier</label><select value={newUser.tier} onChange={e=>setNewUser({...newUser,tier:e.target.value})} style={{width:'100%',padding:10,border:'1px solid #e5e7eb',borderRadius:8,color:'#000'}}><option value="FREE">Free</option><option value="Progressive">Progressive</option><option value="Professional">Professional</option><option value="Cohort">Cohort</option></select></div>
