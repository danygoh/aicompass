        ...
        {activePanel==='users'&&(
          <div>
            <div style={{display:'flex',gap:12,marginBottom:16}}>
              <input placeholder="Search users..." value={userFilter.search} onChange={e=>setUserFilter({...userFilter,search:e.target.value})} style={{padding:'10px 14px',border:'1px solid #e5e7eb',borderRadius:8,flex:1,maxWidth:300,color:'#000'}} />
              <select value={userFilter.cohort} onChange={e=>setUserFilter({...userFilter,cohort:e.target.value})} style={{padding:'10px 14px',border:'1px solid #e5e7eb',borderRadius:8,minWidth:150,color:'#000'}}>
            ...
            {showAddUser && (
              <div style={{background:'#fff',border:'1px solid #e5e7eb',borderRadius:12,padding:20,marginBottom:16}}>
                ...
                <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:16}}>
                  <div><label style={{fontSize:12,color:'#6b7280',display:'block',marginBottom:4}}>Name *</label><input placeholder="Full name" value={newUser.name} onChange={e=>setNewUser({...newUser,name:e.target.value})} style={{width:'100%',padding:10,border:'1px solid #e5e7eb',borderRadius:8,color:'#000'}} /></div>
                  <div><label style={{fontSize:12,color:'#6b7280',display:'block',marginBottom:4}}>Email *</label><input placeholder="email@example.com" type="email" value={newUser.email} onChange={e=>setNewUser({...newUser,email:e.target.value})} style={{width:'100%',padding:10,border:'1px solid #e5e7eb',borderRadius:8,color:'#000'}} /></div>
                  <div><label style={{fontSize:12,color:'#6b7280',display:'block',marginBottom:4}}>Password *</label><input placeholder="Temporary password" type="password" value={newUser.password} onChange={e=>setNewUser({...newUser,password:e.target.value})} style={{width:'100%',padding:10,border:'1px solid #e5e7eb',borderRadius:8,color:'#000'}} /></div>
                  <div><label style={{fontSize:12,color:'#6b7280',display:'block',marginBottom:4}}>Company</label><input placeholder="Company name" value={newUser.company} onChange={e=>setNewUser({...newUser,company:e.target.value})} style={{width:'100%',padding:10,border:'1px solid #e5e7eb',borderRadius:8,color:'#000'}} /></div>
                  <div><label style={{fontSize:12,color:'#6b7280',display:'block',marginBottom:4}}>Tier</label><select value={newUser.tier} onChange={e=>setNewUser({...newUser,tier:e.target.value})} style={{width:'100%',padding:10,border:'1px solid #e5e7eb',borderRadius:8,color:'#000'}}><option value="FREE">Free</option><option value="PROFESSIONAL">Professional</option><option value="TEAM">Team</option><option value="ENTERPRISE">Enterprise</option></select></div>
